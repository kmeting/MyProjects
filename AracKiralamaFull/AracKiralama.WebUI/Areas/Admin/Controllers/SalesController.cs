...
namespace AracKiralama.WebUI.Areas.Admin.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        public SalesController(IService<Satis> service, IService<Arac> serviceArac, IService<Musteri> serviceMusteri, IService<Marka> serviceMarka)
        {
            _Service = service;
      ...
      .ToList();
        ...
        {
            var musteriListesi = await _ServiceMusteri.GetAllAsync();
            var arananMusteri = musteriListesi.FirstOrDefault(m => m.TcNo == q);

            if (arananMusteri != null)
            {
                ViewData["AdSoyad"] = $"{arananMusteri.Adi} {arananMusteri.Soyadi} {arananMusteri.TcNo}";
                return View(arananMusteri);
            }
            else
            {
                TempData["TcNo"] = q;
